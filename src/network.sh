...
getHostPorts() {
  ...
  if [[ "${QEMUDISPLAY,,}" == "vnc" ]] || [[ "${QEMUDISPLAY,,}" == "web" ]]; then
...
#  update-alternatives --set ip6tables /usr/sbin/ip6tables-legacy > /dev/null
  ...
  #0.0.0.0:6901 (KASM VNC server)
  #0.0.0.0:4902 (KASM upload service)
  #0.0.0.0:4903 (KASM audio input)

  HOST_PORTS="$HOST_PORTS,80,443,6901,4902,4903"
